...
export default function SlugSettingsBlock({ projectId, initialSlug }: SlugSettingsBlockProps) {
  ...
  return (
    <div className="w-full space-y-3">
      ...
      <div className="flex items-stretch h-11 rounded-xl border border-[#333333] bg-[#1A1A1A] overflow-x-hidden focus-within:ring-1 focus-within:ring-[#77CC00] focus-within:border-[#77CC00] transition-all">
        {/* Fixed prefix */}

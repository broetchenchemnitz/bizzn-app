...
function AddDishForm({ categories }: { categories: Category[] }) {
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-2.5 bg-gray-900 border border-gray-600 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#C7A17A] focus:ring-1 focus:ring-[#C7A17A] transition-all"
          />
        </div>
        <div>
          <label className="block text-sm font-medium text-gray-300 mb-1">
          ...
          <select
            ...
            className="w-full px-4 py-2.5 bg-gray-900 border border-gray-600 rounded-xl text-white focus:outline-none focus:border-[#C7A17A] focus:ring-1 focus:ring-[#C7A17A] transition-all disabled:opacity-50"
          >
      ...
      {success && (
        <p className="text-sm text-[#C7A17A] bg-green-950/30 border border-green-800/40 px-4 py-2.5 rounded-xl">
      ...
      <button
        ...
        className="bg-[#C7A17A] text-black font-bold px-6 py-2.5 rounded-xl hover:bg-[#B58E62] transition-colors disabled:opacity-50 active:scale-95"
      >
...
function DishRow({
  ...
  if (editing) {
    return (
      <li className="bg-gray-900 border border-[#C7A17A]/40 rounded-xl p-4">
        <form onSubmit={handleUpdate} className="space-y-3">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <input
              ...
              required
              className="px-3 py-2 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm focus:outline-none focus:border-[#C7A17A]"
            />
            <select
              name="category_id"
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              disabled={pending}
              className="bg-[#C7A17A] text-black font-bold px-4 py-1.5 rounded-lg text-sm hover:bg-[#B58E62] transition-colors disabled:opacity-50"
            >
  ...
  return (
    <li className="group flex items-center justify-between bg-gray-900/60 border border-gray-700/60 hover:border-[#C7A17A]/30 rounded-xl px-4 py-3 transition-all">
      ...
      <span className="text-[#C7A17A] font-bold text-sm ml-4 shrink-0">
      ...
      <div className="flex gap-2 ml-4 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
        <button
          ...
          className="px-3 py-1 text-xs font-semibold border border-gray-600 text-gray-300 hover:border-[#C7A17A] hover:text-[#C7A17A] rounded-lg transition-colors"
        >
          Bearbeiten
        </button>
        <button
